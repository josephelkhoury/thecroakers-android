...
import com.thecroakers.app.ActivitesFragment.LiveStreaming.LiveUserAdapter;
...
public class LiveUsersA extends AppCompatActivity implements View.OnClickListener {
    ...
    public void openTicTicLive(String userId, String userName, String userImage, int role) {
        ...
        intent.putExtra(com.thecroakers.app.ActivitesFragment.LiveStreaming.Constants.KEY_CLIENT_ROLE, role);
