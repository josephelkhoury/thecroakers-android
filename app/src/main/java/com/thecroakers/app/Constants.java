...
public class Constants {
    ...
    public static final String apply_as_croaker_or_publisher = "https://thecroakers.com/#APPLY";
    ...
    public static final String Product_ID1="com.thecroakers.musictoktwo";

    public static final String COINS2="2000";
    public static final String PRICE2="$20";
    public static final String Product_ID2="com.thecroakers.musictokthree";

    public static final String COINS3="5000";
    public static final String PRICE3="$50";
    public static final String Product_ID3="com.thecroakers.musictokfour";
