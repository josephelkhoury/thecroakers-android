...
import com.thecroakers.app.ActivitesFragment.LiveStreaming.CallBack;
import com.thecroakers.app.ActivitesFragment.SendGift.StickerModel;
import com.thecroakers.app.ActivitesFragment.SplashA;
...
import com.thecroakers.app.Models.MultipleAccountModel;
...
/**
 * Created by thecroakers on 2/20/2019.
 */
...
// getCurrent Date
    ...
    public static HomeModel parseVideoData(JSONObject userObj, JSONObject sound, JSONObject video, JSONObject topic, JSONObject country, JSONObject userPrivacy, JSONObject userPushNotification) {
        ...
        if (topic != null) {
            item.topic_id = topic.optString("id");
            item.topic_name = topic.optString("name");
        }

        if (country != null) {
            item.country_id = country.optString("id");
            item.country_name = country.optString("name");
        }
